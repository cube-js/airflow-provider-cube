...
AIRFLOW_CONN_CUBE_WRONG_EXTRA = json.dumps(
    {
        ...
        "host": "https://example.cube.dev",
        "password": "23dff8b29cf20df38a4c78dfaf689fa55916add4d27ee3dd9ba75d14732aafa3",
        "extra": {"securityContext": {"expiresIn": "7d"}},
    }
)
...
@mock.patch.dict(
    "os.environ", AIRFLOW_CONN_CUBE_WRONG_HOST=AIRFLOW_CONN_CUBE_WRONG_HOST
)
...
@mock.patch.dict(
    "os.environ", AIRFLOW_CONN_CUBE_WRONG_EXTRA=AIRFLOW_CONN_CUBE_WRONG_EXTRA
)
...
class TestCubeHook:
    ...
    def test_no_host(self):
        ...
        with pytest.raises(
            TypeError, match="Cube's connection host is missed or invalid."
        ):
            hook.run()
    ...
    def test_no_extra(self):
        ...
        with pytest.raises(
            TypeError, match="Cube's securityContext is missed or invalid."
        ):
            hook.run()
